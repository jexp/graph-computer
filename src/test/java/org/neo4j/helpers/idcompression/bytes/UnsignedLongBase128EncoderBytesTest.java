...
// MSB -----> LSB
public class UnsignedLongBase128EncoderBytesTest
{
    @Test
    ...
    public void shouldEncodeAndDecodeEightBytes() throws Exception
    {
        ...
        assertEncodeAndDecodeValue( 0x0081020408102040L,
                             bytes( 0x40, 0xC0, 0xC0, 0xC0, 0xC0, 0xC0, 0xC0, 0xC0 ) );
        assertEncodeAndDecodeValue( 0x7FFFFFFFFFFFFFFFL,
                bytes( 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF ) );
    }
    ...
    private void assertEncodeAndDecodeValue( long value, byte[] expectedEncodedBytes )
    {
        ...
        UnsignedLongBase128EncoderBytes encoder = new UnsignedLongBase128EncoderBytes();
